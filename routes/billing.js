...
const departments={"admin":1,"managing":2,"billing":3,"inventory":4};
    ...
    con.query("update customer set c_otp=? where c_mobileno=?",[otp,Number(req.body.mobile)],async (e,result)=>{
      if(e) console.log(e);
        ...
        if(result.affectedRows!=0){
          try{
            await client.messages.create({from:"+12286788245",to:`+91${req.body.mobile}`,body:`VERIFICATION OTP is ${otp}`});
